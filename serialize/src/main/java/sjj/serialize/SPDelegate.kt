...
class DelegateSharedPreferences<T>(private val def: T, private val k: String? = null, val sp: () -> SharedPreferences?) {
 ...
 */
class DelegateLiveData<T>(private val def: T, private val k: String? = null, val sp: () -> SharedPreferences?) {
